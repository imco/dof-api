...
Fechas de última actualización por tabla:
...
<ul>
	<li><a href="/catalogonoms/error/fecha-publicacion"><?php
		echo \Cache::remember('fechaErronea', 200, function() {
			return NormaVigente::conFechaPublicacionIncorrecta()->count();
		});
		?> Normas vigentes</a> con una fecha de publicación en la que no existe publicación del Diario Oficial de la Federación</li>
...
<ul>
	<li>Publicaciones del DOF <?php echo \Cache::remember('cuentaDOF', 200, function() { return DofNota::count();});?></li>
	<li>Menciones de claves <?php echo \Cache::remember('cuentaMenciones', 200, function() { return MencionEnNota::count();});?></li>
	<li>Menciones de claves únicas <?php echo \Cache::remember('cuentaMencionesUnicas', 200, function() { return MencionEnNota::select('mencion')->distinct('mencion')->count('mencion');});?></li>
</ul>
